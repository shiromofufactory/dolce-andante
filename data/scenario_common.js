...
"1-05": {
  ...
  nodes: [
    { type: "clearChara", pos: "all" },
    { text: "暑い。梅雨が明けた。銀杏並木の下のベンチで、昼飯を食っていると、珍しく一人のまーちゃんが通りかかった。いつもは渡部と一緒にいる印象が強いから、少しだけ意外だった。" },
...
"1-12": {
  ...
  nodes: [
    ...
    { text: "ヒマリちゃんは、自分のパートを丁寧に弾いていた。渡部は、勢いで何とかしていた。中野さんは、いつも通り淡々と、自分のパートを刻んでいた。――彼女は、本番だけは、絶対に来る。でも、本番前後の打ち上げや打ち合わせには、一切顔を出さない。それが、中野さんだ。" },
...
"1-15-r1": {
  ...
  nodes: [
    ...
    { type: "effect", effects: [{ flag: "mio_invite_hinted", value: true }] }
  ],
  next: "1-18"
},
"1-15-r2": {
...
"1-19b": {
  ...
  nodes: [
    { type: "condJump",
      branches: [
        { cond: { flag: "mio_invite_hinted" }, to: "1-19b-hint" }
      ],
      default: "1-19b-plain" }
  ]
},
"1-19b-hint": {
  ...
  nodes: [
    { type: "clearChara", pos: "all" },
    { text: "風呂上がり、髪を拭きながら、部屋の窓を開ける。夏の夜風。携帯が、ピコン、と鳴った。" },
    { speaker: "ミオ（メール）", text: "今日、お疲れさま。ふれんちのコントラバス、ちゃんと聞こえたよ。思ったより上手くなってて、ちょっと感動した。" },
    { speaker: "ミオ（メール）", text: "……さっき、言いそびれたんだけど、私、８月、免許合宿行くんだ。ふれんちは、どうする？" },
...
"1-19b-plain": {
  ...
  nodes: [
    ...
    { text: "風呂上がり、髪を拭きながら、部屋の窓を開ける。夏の夜風。携帯が、ピコン、と鳴った。" },
    { speaker: "ミオ（メール）", text: "今日、お疲れさま。ふれんちのコントラバス、ちゃんと聞こえたよ。思ったより上手くなってて、ちょっと感動した。" },
    { speaker: "ミオ（メール）", text: "私、８月、免許合宿行くんだ。ふれんちは、どうする？" },
    { text: "――ユタカから聞いた話と、これで繋がる。俺は、しばらく携帯を見つめたあと、返信を打ち始めた。" },
    { type: "choice", choices: [
      { label: "「俺も行く。同じ合宿にする」と踏み込む",
        effects: [{ param: "mio", delta: 2 }, { flag: "summer_path", value: "A" }, { flag: "license_camp", value: true }],
        goto: "1-19-r1" },
...
"4-01": {
  ...
  nodes: [
    ...
    { speaker: "団員", text: "おー！" },
    { text: "『あんだんて』の仕組みは単純だ。学園祭の中庭スペースに、木造の屋台を組んで、その前にイスとテーブルを並べる。コーヒーとお茶菓子を出す。" },
    { text: "そして、団員が入れ替わり立ち替わりで、屋台のすぐ脇で小さな生演奏をする。――それが、ここ数十年続いている、うちの学園祭の風物詩だ。" }
  ],
  next: "4-02"
},
